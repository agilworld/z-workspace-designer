  ...
  if (!product || !chairSlot) {
    return (
      <div className="flex flex-col rounded-2xl bg-white shadow-md hover:shadow-lg border border-slate-200 hover:border-slate-300 p-5 transition-all duration-300">
        <h3 className="mb-3 text-base font-bold text-slate-700">Chair</h3>
    ...
    <>
      <div className="flex flex-col rounded-2xl bg-white shadow-md hover:shadow-lg border border-slate-200 hover:border-slate-300 p-5 transition-all duration-300">
        ...
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-base font-bold text-slate-700">Chair</h3>
          <button
            type="button"
        ...
        <div className="space-y-1.5">
          <p className="text-xs font-semibold text-slate-500">Color:</p>
